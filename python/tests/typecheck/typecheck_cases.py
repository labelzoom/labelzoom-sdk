"""The four ``typecheck/*`` conformance cases, checked by mypy instead of by pytest.

``conformance/skips/python.json`` declares these four cases skipped because Python has no
...
# typecheck/epl-is-not-a-target
client.convert("zpl", "epl", body)  # type: ignore[arg-type]

# typecheck/tspl-is-not-a-target
client.convert("zpl", "tspl", body)  # type: ignore[arg-type]

# typecheck/dpl-is-not-a-target
client.convert("zpl", "dpl", body)  # type: ignore[arg-type]
